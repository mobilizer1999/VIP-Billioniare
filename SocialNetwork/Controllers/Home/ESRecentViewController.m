...
@interface ESRecentViewController () {
...
@implementation ESRecentViewController
...
//    self.cachedImages = [NSMutableDictionary new];
    self.title = NSLocalizedString(@"Recent posts", nil);
...
- (void)objectsDidLoad:(NSError *)error {
    ...
    else
    {
        ...
        labelView.text = @"No recent posts";
