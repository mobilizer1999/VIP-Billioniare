...
@interface ESAccountViewController : ESPhotoTimelineAccountViewController <UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
