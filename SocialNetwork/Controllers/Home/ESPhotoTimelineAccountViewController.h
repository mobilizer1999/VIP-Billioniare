//
//  ESPhotoTimelineAccountViewController.h
//  d'Netzwierk
//
...
enum ActionSheetTags {
    ...
    EditPostTag = 7,
    ChangeHeaderPictureTag = 21,
    ReportUserTag = 22,
    ReportReasonTag = 23,
};

/**
 *  Number of static sections in the timeline, in case we want to display something static.
 */
static const int NUMBER_OF_STATIC_SECTIONS = 0 ;
/**
 *  Number of static cells in the timeline, in case we want to display something static.
 */
static const int NUMBER_OF_STATIC_CELLS = 0 ;
/**
 *  Interface of the timeline for the profile page viewcontroller.
 */
@interface ESPhotoTimelineAccountViewController : PFQueryTableViewController <ESPhotoHeaderViewDelegate,UITableViewDelegate,ESPhotoFooterViewDelegate, ESFindFriendsCellDelegate,UIActionSheetDelegate>
/**
...
@property (nonatomic, assign) BOOL currentUserOwnsPhoto;
