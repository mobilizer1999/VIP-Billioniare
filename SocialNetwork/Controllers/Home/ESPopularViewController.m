...
@interface ESPopularViewController () {
...
@implementation ESPopularViewController
...
//    self.cachedImages = [NSMutableDictionary new];
    self.title = NSLocalizedString(@"Popular posts", nil);
...
- (void)objectsDidLoad:(NSError *)error {
    ...
    if ([self.objects count] > 0) {
        ...
        labelView.text = NSLocalizedString(@"No popular posts", nil);
