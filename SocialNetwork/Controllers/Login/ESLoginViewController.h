...
@property bool signupView;
-(IBAction)actionSignup:(id)sender;
/**
 *  Cell containing a textfield for the first name.
 */
@property (strong, nonatomic) IBOutlet UITableViewCell *cellEmail;
/**
 *  Cell containing a textfield for the password.
 */
@property (strong, nonatomic) UIImageView *logoImage, *logoTextImage;
@property (strong, nonatomic) IBOutlet UITableViewCell *cellPassword;
@property (strong, nonatomic) IBOutlet UITableViewCell *cellPrivacyPolicy;
@property (strong, nonatomic)PrivacyPolicyViewController *objPrivacyPolicyViewController;
/**
...
@property (strong, nonatomic) IBOutlet UITableViewCell *cellForgotPassword;
