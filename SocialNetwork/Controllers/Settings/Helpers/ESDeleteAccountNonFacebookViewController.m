...
- (void)viewDidLoad {
    ...
    self._tableView.separatorColor = def_Golden_Color8;
...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            tf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Enter Username", nil) attributes:@{NSForegroundColorAttributeName: def_Golden_Color5}];
            tf.secureTextEntry = NO;
            tf.delegate = self;
            tf.autocorrectionType = UITextAutocorrectionTypeNo ;
            tf.autocapitalizationType = UITextAutocapitalizationTypeNone;
            tf.adjustsFontSizeToFitWidth = YES;
            tf.textColor = def_Golden_Color;//[UIColor colorWithRed:56.0f/255.0f green:84.0f/255.0f blue:135.0f/255.0f alpha:1.0f];
            [cell addSubview:tf];
        }
        else {
            tf2 = [[UITextField alloc] initWithFrame:CGRectMake(10, 2, 200, 40)];
            tf2.attributedPlaceholder = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Enter Password", nil) attributes:@{NSForegroundColorAttributeName: def_Golden_Color5}];
            ...
            tf2.textColor = def_Golden_Color;//[UIColor colorWithRed:56.0f/255.0f green:84.0f/255.0f blue:135.0f/255.0f alpha:1.0f];
            [cell addSubview:tf2];
        }
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 0) {
        ...
        label.textColor = def_Golden_Color;//[UIColor darkGrayColor];
