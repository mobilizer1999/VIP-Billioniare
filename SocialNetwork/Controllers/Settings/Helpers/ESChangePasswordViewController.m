...
- (void)viewDidLoad {
    ...
    [self.navigationItem.leftBarButtonItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor colorWithWhite:1 alpha:1],  UITextAttributeTextColor,nil] forState:UIControlStateNormal];
    ...
    self._tableView.separatorColor = [UIColor colorWithWhite:0 alpha:0.8];
...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            tf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Enter email address", nil) attributes:@{NSForegroundColorAttributeName: [UIColor colorWithWhite:0 alpha:0.5]}];
            tf.secureTextEntry = NO;
            tf.delegate = self;
            tf.autocorrectionType = UITextAutocorrectionTypeNo ;
            tf.autocapitalizationType = UITextAutocapitalizationTypeNone;
            tf.adjustsFontSizeToFitWidth = YES;
            tf.textColor = [UIColor colorWithWhite:0 alpha:1];//[UIColor colorWithRed:56.0f/255.0f green:84.0f/255.0f blue:135.0f/255.0f alpha:1.0f];
            [cell addSubview:tf];
        }
        else if (indexPath.row == 1) {
            tf2 = [[UITextField alloc] initWithFrame:CGRectMake(10, 2, 200, 40)];
            tf2.attributedPlaceholder = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Enter old Password", nil) attributes:@{NSForegroundColorAttributeName: [UIColor colorWithWhite:0 alpha:0.5]}];
            ...
            tf2.textColor = [UIColor colorWithWhite:0 alpha:1];//[UIColor colorWithRed:56.0f/255.0f green:84.0f/255.0f blue:135.0f/255.0f alpha:1.0f];
            [cell addSubview:tf2];
        }
        else {
            tf3 = [[UITextField alloc] initWithFrame:CGRectMake(10, 2, 200, 40)];
            tf3.attributedPlaceholder = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Enter new Password", nil) attributes:@{NSForegroundColorAttributeName: [UIColor colorWithWhite:0 alpha:0.5]}];
            ...
            tf3.textColor = [UIColor colorWithWhite:0 alpha:1];//[UIColor colorWithRed:56.0f/255.0f green:84.0f/255.0f blue:135.0f/255.0f alpha:1.0f];
            [cell addSubview:tf3];
        }
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 0) {
        ...
        [label setFont:[UIFont fontWithName:@"Montserrat-Regular" size:14]];
        label.textColor = [UIColor colorWithWhite:0 alpha:1];//[UIColor darkGrayColor];
