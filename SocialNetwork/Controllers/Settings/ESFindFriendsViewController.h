...
typedef enum {
    ESFindFriendsFollowingNone = 0,    // User isn't following anybody in Friends list
    ESFindFriendsFollowingAll,         // User is following all Friends
    ESFindFriendsFollowingSome         // User is following some of their Friends
} ESFindFriendsFollowStatus;

/**
 *  Interface of the ESFindFriendsViewController, used to find new friends and other users.
 */
@interface ESFindFriendsViewController : PFQueryTableViewController <ESFindFriendsCellDelegate, ABPeoplePickerNavigationControllerDelegate, MFMailComposeViewControllerDelegate, MFMessageComposeViewControllerDelegate, UIActionSheetDelegate, UISearchBarDelegate>
/**
 *  Header of the UITableView
 */
@property (nonatomic, strong) NSMutableArray* followingMeUsers;
