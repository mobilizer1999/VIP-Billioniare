...
@interface ESSelectRecipientsViewController : UITableViewController <UISearchBarDelegate,AddGroupDelegate>
{
    /**
...
@property (assign, nonatomic) BOOL isFromGroupInfoView;
@property (strong, nonatomic) NSMutableArray *arrExistimgMemberList;
