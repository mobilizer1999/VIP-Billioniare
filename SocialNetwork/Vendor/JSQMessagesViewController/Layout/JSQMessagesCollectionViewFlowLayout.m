...
- (void)jsq_configureFlowLayout
{
    ...
    _messageBubbleTextViewTextContainerInsets = UIEdgeInsetsMake(7.0f, 14.0f, 3.0f, 14.0f);
...
- (CGSize)messageBubbleSizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([messageItem isMediaMessage]) {
        ...
        CGRect stringRect = [[messageItem text] boundingRectWithSize:CGSizeMake(maximumTextWidth - 60, CGFLOAT_MAX)
