...
{
    return nil;
    return [UIImage jsq_bubbleImageFromBundleWithName:@"clip_plus"];
}
+ (UIImage *)jsq_rightmiddleImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"camera_t"];
}

+ (UIImage *)jsq_rightermiddleImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"image"];
}


+ (UIImage *)jsq_rightImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"record"];
}
