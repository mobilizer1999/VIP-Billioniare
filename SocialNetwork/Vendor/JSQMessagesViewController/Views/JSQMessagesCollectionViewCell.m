...
//    self.cellTopLabel.textAlignment = NSTextAlignmentCenter;
    self.cellTopLabel.font = [UIFont fontWithName:@"Montserrat-Bold" size:12.0f];
    self.cellTopLabel.textColor = [UIColor lightGrayColor];

    self.messageBubbleTopLabel.font = [UIFont fontWithName:@"Montserrat-Regular" size:12.0f];
    self.messageBubbleTopLabel.textColor = [UIColor colorWithWhite:0 alpha:0.7];//[UIColor lightGrayColor];
    
   // self.messageBubbleImageView.contentMode = UIViewContentModeScaleAspectFit; // shweta bubbleimage

    self.cellBottomLabel.font = [UIFont fontWithName:@"Montserrat-Regular" size:11.0f];
