...
{    
    ...
    UIImage *normalImage = accessoryImage;
    UIImage *highlightedImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor darkGrayColor]];

    UIButton *accessoryButton = [[UIButton alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 32, 32.0f)];
...
+ (UIButton *)rightmiddleImage
{
    UIImage *accessoryImage = [UIImage jsq_rightmiddleImage];
    UIImage *normalImage = accessoryImage;
    UIImage *highlightedImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor darkGrayColor]];
...
+ (UIButton *)rightermiddleImage
{
    UIImage *accessoryImage = [UIImage jsq_rightermiddleImage];
    UIImage *normalImage = accessoryImage;
    UIImage *highlightedImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor darkGrayColor]];
...
+ (UIButton *)rightImage
{
    UIImage *accessoryImage = [UIImage jsq_rightImage];
    UIImage *normalImage = accessoryImage;
    UIImage *highlightedImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor darkGrayColor]];
...
//    [sendButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateDisabled];
    ...
    sendButton.titleLabel.font = [UIFont fontWithName:@"Montserrat-Bold" size:17.0f];
