         ...
         completion:(PXAlertViewCompletionBlock)completion
{
    ...
    if (self) {
        ...
        self.alertView.backgroundColor = [UIColor colorWithWhite:0.35 alpha:1];
        ...
        self.titleLabel.font = [UIFont fontWithName:@"Montserrat-Bold" size:17];
        ...
        self.messageLabel.font = [UIFont fontWithName:@"Montserrat-Regular" size:15];
...
- (UIButton *)genericButton
{
    ...
    button.titleLabel.font = [UIFont fontWithName:@"Montserrat-Regular" size:17];
...
{
    [sender setBackgroundColor:[UIColor colorWithRed:20/255.0 green:154/255.0 blue:232/255.0 alpha:1.0]];
}
...
- (NSInteger)addButtonWithTitle:(NSString *)title
{
    ...
    if (!self.cancelButton) {
        ...
        lastButton.titleLabel.font = [UIFont fontWithName:@"Montserrat-Regular" size:17];
        ...
        self.cancelButton.titleLabel.font = [UIFont fontWithName:@"Montserrat-Regular" size:17];
    }
