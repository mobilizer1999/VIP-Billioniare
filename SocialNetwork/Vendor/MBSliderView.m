...
static const CGFloat gradientDimAlpha = 0.7;
...
- (void) loadContent {
    ...
    if (!_label || !_slider) {
        ...
        _label = [[MBSliderLabel alloc] initWithFrame:self.bounds];
//        _label.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
        ...
        _label.font = [UIFont fontWithName:@"Montserrat-Medium" size:32];
        _label.text = @"Slide";
...
//    CGFloat sliderWidth = 0;//[_slider thumbImageForState:_slider.state].size.width;
