...
typedef enum {
    ...
    ESPhotoFooterButtonsShareButton = 1 << 6,
    ESPhotoFooterButtonsCommentLikeButton = 1 << 7,
    
    ESPhotoFooterButtonsDefault = ESPhotoFooterButtonsLike | ESPhotoFooterButtonsComment | ESPhotoFooterButtonsUser | ESPhotoFooterButtonsLabel | ESPhotoFooterButtonsLabelComment | ESPhotoFooterButtonsLikeImage | ESPhotoFooterButtonsShareButton | ESPhotoFooterButtonsCommentLikeButton
