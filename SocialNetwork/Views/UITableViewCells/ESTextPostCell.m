...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        [self.postText setTextColor:[UIColor colorWithWhite:0.2 alpha:1]];
        [self.postText setTintColor:[UIColor colorWithWhite:0.2 alpha:1]];
        self.postText.frame = CGRectMake( 25.0f, 0.0f, [UIScreen mainScreen].bounds.size.width - 28, 50);
...
//        self.postText.layer.borderWidth = 1.0f;
        self.postText.font= [UIFont fontWithName:@"Montserrat-Regular" size:15];
