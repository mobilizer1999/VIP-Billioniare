...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        mainView.backgroundColor = [UIColor colorWithRed:0.95 green:0.95 blue:0.95 alpha:0];
        ...
        commentField.font = [UIFont fontWithName:@"Montserrat-Regular" size:14.0f];
        ...
        [commentField setValue:[UIColor colorWithWhite:0 alpha:0.5] forKeyPath:@"placeholderLabel.textColor"];
...
- (void)setHideCommentIcon:(BOOL)hideCommentIcon {
    if (hideCommentIcon) {
        [[self viewWithTag:1003] setHidden:YES];
    }
}
#pragma mark - UIView
