...
+ (void)updateConversationItemWitUser:(NSString *)user groupId:(NSString *)groupId members:(NSArray *)members andDescription:(NSString *)description image:(UIImage*)image recentId:(NSString *)recentId;
