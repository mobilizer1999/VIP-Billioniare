...
#define		MESSAGE_OUT_COLOUR						[UIColor colorWithRed:148.0f / 256   green:194.0f/256 blue:228.0f/256 alpha:1]// HEXCOLOR(0x007AFFFF)
#define		MESSAGE_IN_COLOUR						[UIColor colorWithWhite:245.0f/256 alpha: 1] //[UIColor colorWithRed:0.9411 green:0.8431 blue:0.4509 alpha:0.8]//HEXCOLOR(0xE6E5EAFF)
#define		VIDEO_LENGTH                                180 // shweta
...
extern NSString *const kESEditPhotoViewControllerDescriptionKey;
