...
NSString *const kESEditPhotoViewControllerDescriptionKey = @"photoDescription";

#pragma mark - Installation Class

// Field keys
NSString *const kESInstallationUserKey = @"user";
//NSString *const kESChatFirebaseCredentialKey  =  @"https://vip-billionaires.firebaseio.com";
//NSString *const kESChatFirebaseCredentialKey  =  @"https://vip-billionaire.firebaseio.com";
NSString *const kESChatFirebaseCredentialKey  =  @"https://vip-billionaires-c07df.firebaseio.com";
...
//NSString *const kESChatInviteUserMessage                       = @"Check out Netzwierk, the social network for Luxembourg! Available here: https://itunes.apple.com/us/app/netzwierk-dsozialt-netzwierk/id1076103571?mt=8";

NSString *const kESChatInviteUserMessage                       = @"Check out VIP Billionaires, the social network for Luxembourg! Available here: https://itunes.apple.com/in/app/vip-billionaires/id1076103571?mt=8";
